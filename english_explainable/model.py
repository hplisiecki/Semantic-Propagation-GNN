...
from custom_gnn.custom_layers import SPropConvScalarScaling, CustomGlobalAttention
import torch
...
class GNNLayerSequence(nn.Module):
    ...
    def forward(self, x, node_types, edge_index, edge_type):
        ...
        for layer in self.layers:
            ...
            if isinstance(layer, SPropConvScalarScaling):
...
class SPropGNN(nn.Module):
    ...
    def __init__(self, num_node_features, num_node_types, num_relations, metric_names, dropout_prob = 0.3):
        ...
        self.relational_graph = GNNLayerSequence([
            SPropConvScalarScaling(num_node_features, 512),
        ])
    ...
    def forward(self, data):
        ...
        self.activations['s_ij_list'] = [layer.last_s_ij.detach().cpu() for layer in self.relational_graph.layers if isinstance(layer, SPropConvScalarScaling)]
